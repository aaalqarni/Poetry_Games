 ...
 * JavaFX App
 */
public class OrderLastWord extends Application {
   ...
   public int getLevel() {
    ...
    private void switchLastWord(int j1, int j2){
        String s11,s12,s21,s22;
        
        s11=buzzleText[j1].substring(0,buzzleText[j1].lastIndexOf(" ")).trim();
        s12=buzzleText[j1].substring(buzzleText[j1].lastIndexOf(" ")).trim();
                    
        s21=buzzleText[j2].substring(0,buzzleText[j2].lastIndexOf(" ")).trim();
        s22=buzzleText[j2].substring(buzzleText[j2].lastIndexOf(" ")).trim();
                    
        buzzleText[j1]=s11+" "+s22;
        buzzleText[j2]=s21+" "+s12;                    
    }
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Text scenetitle = new Text("لعبة ترتيب كلمة القافية");
     ...
     //--------------------------------------------------------------------
        ...
        actiontarget.setText("رتب آخر كلمة في الأبيات التالي:");
       ...
       switch (getLevel()) {
        ...
        b1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                switchLastWord(1,3);
                l2.setText(buzzleText[1]);
                l4.setText(buzzleText[3]);
       ...
       ///////////////////////////////////////////////////////////////////////// 
        ...
        scene.getStylesheets().add(OrderLastWord.class.getResource("/PoetryGames.css").toExternalForm());        
        primaryStage.show();
