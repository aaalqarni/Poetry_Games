 ...
 * JavaFX App
 */
public class OrderSecondHalf extends Application {
   ...
   public int getLevel() {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        //Scene error_scene = new Scene(error_root, 100, 50);
        ...
        Text scenetitle = new Text("لعبة ترتيب الشطر الثاني");
       ...
       //-----------------------------------------------------------------------
        ...
        actiontarget.setText("رتب الشطر الأخير في الأبيات التالية:");
       ...
       hBox.getChildren().add(actiontTotalScore);
        ...
        scene.getStylesheets().add(OrderSecondHalf.class.getResource("/PoetryGames.css").toExternalForm());        
        primaryStage.show();
